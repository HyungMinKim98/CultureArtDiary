...
const MainPage = () => {
  ...
  useEffect(() => {
    const fetchMovies = async () => {
      try {
        const response = await fetch('https://api.themoviedb.org/3/movie/popular?api_key=50aaab29ad70cc1875e49e7512650e80&language=en-US&page=1');
    ...
    const fetchDramas = async () => {
      try {
        const response = await fetch('https://api.themoviedb.org/3/tv/popular?api_key=50aaab29ad70cc1875e49e7512650e80&language=en-US&page=1');
        const data = await response.json();
        if (data.results) {
